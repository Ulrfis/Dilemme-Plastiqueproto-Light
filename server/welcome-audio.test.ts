...
import { buildWelcomePayload, getWelcomeMessage } from "../shared/welcome-audio.ts";
...
test("reuses the same personalized message for the pre-generated welcome payload", () => {
  assert.deepEqual(buildWelcomePayload("  Lina  ", "audio-token-123"), {
    welcomeMessage: expectedMessage,
    welcomeAudioToken: "audio-token-123",
  });
});
